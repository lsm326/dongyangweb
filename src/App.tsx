...
const translations = {
  ko: {
    ...
    storyText1: "동양여관 1938은 제주의 옛 정취가 남아있는 무근성 골목에 위치한 유서 깊은 공간입니다. 1938년의 건축 양식을 보존하며 한식과 일식 건축양식이 어우러진 독특한 미학을 선보입니다.",
    storyText2: "바다 내음 섞인 바람이 머무는 원도심, 세월의 흔적이 묻어나는 목조 천장 아래서 제주의 진정한 평온함을 마주해보세요.",
    restAndPeace: "쉼\n&\n평온",
    spacesTitle: "공간 안내",
